...
- [x] Три контрольных вопроса с бота: `1.8.2`, `9.9.9`, `5.1.1.1`.
- [x] Локальный CLI / `POST /chat` не сломан.
- [x] README: VPS, Telegram, DeepSeek vs эмбеддинги.
- [x] `docs/known-limitations-sprint-6.md` (облако видит текст сметы в tools).

## 5) Демо

- [x] Разрешённый чат — цифры Excel.
- [x] Чужой чат — без данных индекса.
- [x] Показать, что нет webhook и публичного `:7346`.
